...
def main() -> None:
    ...
    parser.add_argument("--agent_template", type=str, required=True)
    ...
    agent_mod = load_agent_module(args.agent_template)
    ...
    agent_name = (
        args.agent_name or os.path.splitext(os.path.basename(args.agent_template))[0]
    )
